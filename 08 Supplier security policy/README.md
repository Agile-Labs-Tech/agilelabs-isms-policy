...
2. The owner of this document is Information Security Manager (ISM) who must check and, if necessary, update the document at least once a year.
...
1. Security risks related to suppliers, vendors, service providers and partners are identified during the risk assessment process, as defined in the Risk Assessment and Risk Treatment Methodology.
    ...
    3. The ISM or the TL will decide whether it is necessary to conduct additional risk assessments, and propose the implementation of additional risk treatment measures, in relation to the engagements and projects with individual suppliers, vendors, service providers or partners.

## Screening

1. The ISM decides whether it is necessary to perform background verification checks for individual suppliers, vendors, service providers and partners, and if yes – which methods must be used.

## Contracts

1. ISM is responsible for deciding which physical security clauses will be included in the contract with supplier, vendor, service provider or partner.
...
| --- | --- | --- | --- | --- |
| Contracts with suppliers, vendors, service providers and partners | Cloud Directory; office (hard copy) | ISM | TL | 1 year |
