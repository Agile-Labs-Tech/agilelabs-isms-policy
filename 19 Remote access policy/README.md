...
2. Remote access is a generic term used to describe the accessing of Agile Lab Pte Ltd &#39;s (Agile Lab&#39;s) computer network by individuals, who are located outside (for example from home or partner office) logging in and accessing application systems and data.
3. This document is applies to all Agile Lab Pte Ltd (Agile Lab) employees.
