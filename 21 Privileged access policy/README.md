...
| Information Security Officer | As above | - Design, specify and modify log templates – record types and level of detail for each record type <br/>- Specify frequency of creation, versioning or updating of (append) systems and events log files <br/>- Archive or delete &quot;old&quot; versions of log files |

# Records Management

| **Record name** | **Storage location** | **Person responsible for storage** | **Controls for record protection** | **Retention time** |
| --- | --- | --- | --- | --- |
| Systems and events audit logs | Cloud directory;office (hard copy) | Department Managers | Department Managers | 1 year |
